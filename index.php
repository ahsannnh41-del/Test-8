...
session_start();
$file = 'tools.json';
$correct_password = "yha_pr_admin_pannel_pass_lga_lo"; 
...
<?php if (!$is_admin): ?>
    <div class="text-center mt-5 mb-4">
        <h1 style="font-weight:900; letter-spacing:3px; color:#222;">YOUR TOOLKIT NAME</h1>
    ...
    <footer class="text-center mt-5 py-4">
        <div style="font-size: 0.85rem; font-weight:900; letter-spacing:4px; color:#444;">YOUR NAME</div>
        <small style="color:#999; font-size:9px;">© 2026 YOUR NAME</small>
    </footer>
